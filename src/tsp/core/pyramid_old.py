...
literature to approximate human solutions to the TSP. **This model is systematically worse than
the more recent one found in `tsp.core.pyramid`. The code remains for historical reasons only.**
